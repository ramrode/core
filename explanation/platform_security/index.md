...
In a [high-availability](https://docs.ellanetworks.com/explanation/high_availability/index.md) cluster, inter-node communication is secured with mutual TLS (TLS `1.3`) using fingerprint-pinned, per-node self-signed certificates.
