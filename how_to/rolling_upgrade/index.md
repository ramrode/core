...
1. Open the **Cluster** page on the leader.
...
1. On the last pass, reopen the **Cluster** page on the new leader. Click **Resume** next to the node. Wait for **Drain State** to clear back to `active`.
