...
`tcx` mode requires both interfaces to deliver unmerged packets — see [Disable merged packets](https://docs.ellanetworks.com/how_to/disable_merged_packets/index.md).
